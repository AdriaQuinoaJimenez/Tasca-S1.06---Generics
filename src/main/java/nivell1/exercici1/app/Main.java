...
public class Main {
    public static void main(String[] args) {
        ...
        objectRecovered = ((String) noGenericMethods1.getObj2());
        objectLength = objectRecovered.length();

        System.out.println("noGenericMethods1 length: " + objectLength);
    }
}